...
<!--        <a href="#" type="button" class="list-group-item" data-toggle="collapse" data-target="#messages"><i class="fa fa-envelope"></i> Messages</a>
        ...
        <div id="resources" class="collapse">
            ...
            <a href="{{URL::to("agent/resources-current")}}" class="list-group-item " style=""><i class="fa fa-chevron-right"></i> Current</a>
            <a href="{{URL::to("agent/resources-history")}}" class="list-group-item " style=""><i class="fa fa-chevron-right"></i> History</a>
        </div>
