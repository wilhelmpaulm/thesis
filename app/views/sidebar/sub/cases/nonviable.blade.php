    ...
    <div class="panel-heading">
        ...
        <div style="height: 450px; overflow-y:auto">
            ...
            <ul class="list list-unstyled    ">
                ...
                <li><a  id="" href="{{URL::to(strtolower(Auth::user()->job_title).'/cases-non-viable/'.$case->id)}}" data-case_id="{{$case->id}}" class="list-group-item c_link">
                        <h4 class="list-group-item-heading list_name ">{{$case->name}}</h4>
                        <p class="list_created_at label label-info">{{$case->created_at}}</p>
